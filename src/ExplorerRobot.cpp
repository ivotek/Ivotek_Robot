...
bool ExplorerRobot::genericSwitch(byte pin)
{
    bool value;
...
bool ExplorerRobot::genericSwitch(bool invert, byte pin)
{
    bool value;
    value = digitalRead(pin);
    delay(10);
...
bool ExplorerRobot::switchSxFront()
{
    return genericSwitch(arduinoPins.d7);
    return false;
}

bool ExplorerRobot::switchDxFront()
{
    return genericSwitch(arduinoPins.d4);
    return false;
}

bool ExplorerRobot::switchSxFront(bool invert)
{
    return genericSwitch(arduinoPins.d7, invert);
    return false;
}

bool ExplorerRobot::switchDxFront(bool invert)
{
    return genericSwitch(arduinoPins.d4, invert);
    return false;
}
